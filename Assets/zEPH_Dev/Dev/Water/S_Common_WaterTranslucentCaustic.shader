Shader "Custom/Common Water Translucent Caustic"
{
    // ---------------------------------------------------------------------------
    // 属性定义
    // ---------------------------------------------------------------------------
    Properties
    {
        ...
        [Header(Caustics)]
        [Space(5)]
        [Toggle(_CAUSTICS)] _UseCaustics("启用焦散", Float) = 0
        _CausticTex("焦散贴图 (R/G/B 序列或噪声)", 2D) = "black" {}
        _CausticScale("焦散缩放", Range(0.1, 10)) = 1.0
        _CausticSpeed("焦散流速", Range(0, 2)) = 0.2
        _CausticIntensity("焦散强度", Range(0, 5)) = 1.0
        _CausticRGBSplit("色散偏移", Range(0, 0.05)) = 0.01
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _CAUSTICS          // 是否开启焦散
